...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 18, 2022 at 02:49 PM
...
--
-- Dumping data for table `tb_identifikasi_detail`
--
...
--
-- Dumping data for table `tb_pertanyaan_detail`
--
...
--
-- Dumping data for table `tb_rule_penyakit`
--
...
(1, 'Iman Nur Izza', '1234', 'muhimannurizza@gmail.com', 'default.png', 1, 1, NULL, '2022-06-21 02:15:01'),
(7, 'Ali Sans', '1234', 'teamsans71@gmail.com', 'default.png', 1, 0, 'evbHf40K7SLjU40W9w6fsgDwraIW54F/MXckVhlYlHU=', '2022-07-17 09:02:26');
...
--
-- Indexes for table `tb_identifikasi_detail`
--
ALTER TABLE `tb_identifikasi_detail`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_pertanyaan_detail`
--
ALTER TABLE `tb_pertanyaan_detail`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_rule_penyakit`
--
ALTER TABLE `tb_rule_penyakit`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tb_identifikasi_detail`
--
ALTER TABLE `tb_identifikasi_detail`
...
--
-- AUTO_INCREMENT for table `tb_pertanyaan_detail`
--
ALTER TABLE `tb_pertanyaan_detail`
...
--
-- AUTO_INCREMENT for table `tb_rule_penyakit`
--
ALTER TABLE `tb_rule_penyakit`
